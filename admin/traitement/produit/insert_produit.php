...
<head>
    ...
    <title>Formulaire d'insertion page Produit</title>
</head>
<body>
    <h2 class="text-center titre_formulaire">Formulaire d'ajout de produit</h2>
    <form class="text-center mx-auto" action="insert_produit_traitement.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input class="form-control  mx-auto" type="number" name="prix" step="0.01" min="0" max="100" required>
        </div>
